...
import { UserCertificatesEditView } from 'src/sections/userCertificates/view';
...
export default function Page() {
  ...
  const getMedias = useCallback(async () => {
    await AxiosComponent({
      method: 'get',
      url: `${BASE_LMS_API}/user-certificates/${id}`,
  ...
  return (
    <>
      ...
      <UserCertificatesEditView Loading={isLoading} UserCertificates={tableData} />
    </>
  );
}
