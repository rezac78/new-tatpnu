...
import { SubMenuEditView } from 'src/sections/submenu/view';

// ----------------------------------------------------------------------

const metadata = { title: `ویرایش زیر منو | داشبورد - ${CONFIG.site.name}` };
...
export default function Page() {
  ...
  return (
    <>
      ...
      <SubMenuEditView Loading={isLoading} submenu={tableData} />
    </>
  );
}
