...
export function ExamQuestionEditView({ ExamQuestion: currentExamQuestion, Loading }) {
  const t = fa;
  return (
    <DashboardContent>
      <CustomBreadcrumbs
        ...
        links={[
          ...
          { name: currentExamQuestion?.question },
        ]}
        sx={{ mb: { xs: 3, md: 5 } }}
      />

      <ExamQuestionNewEditForm Loading={Loading} currentExamQuestion={currentExamQuestion} />
    </DashboardContent>
  );
}
