...
import { SubMenuTableRow } from '../submenu-table-row';
import { SubMenuTableToolbar } from '../submenu-table-toolbar';
...
export function SubMenuListView() {
  ...
  const handleDeleteRow = useCallback(
    (id) => {
      ...
      AxiosComponent({
        method: 'delete',
        url: `${BASE_LMS_API}/sub-menus/${DeleteItem[0].id}`,
        callback: (status, data) => {
          if (status) {
  ...
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.dashboard.submenu.edit(id));
    },
    [router]
  );
        ...
        <CustomBreadcrumbs
          ...
          action={
            <Button
              ...
              href={paths.dashboard.submenu.new}
              variant="contained"
