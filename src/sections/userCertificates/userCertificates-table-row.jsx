...
export function UserCertificatesTableRow({ row, selected, rowCount, onEditRow, onSelectRow, onDeleteRow }) {
  ...
  return (
    <>
      <TableRow hover selected={selected} aria-checked={selected} tabIndex={-1}>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row.user_mobile}</TableCell>
        <TableCell>
